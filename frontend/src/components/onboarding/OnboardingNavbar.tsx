export default function OnboardingNavbar({ step }: { step: number }) {
  return (
    ...
    >
      <img src="/logo.svg" alt="Mergly" className="hidden sm:block" style={{ height: '26px', width: 'auto' }} />
      <img src="/icon-white.svg" alt="Mergly" className="block sm:hidden" style={{ height: '26px', width: 'auto' }} />
      <span
